...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
		typeof window.define === 'function' && window.define.amd ? window.define(factory) :
	...
	var global_1 =
		...
		check(typeof window.self == O && window.self) ||
	...
	*/
	...
	/** Detect free variable `window.self`. */
	...
	var freeSelf$1 = typeof window.self == 'object' && window.self && window.self.Object === Object && window.self;
	...
	/** Detect free variable `self`. */
	var freeSelf$2 = typeof window.self == 'object' && window.self && window.self.Object === Object && window.self;
	...
	var global$1 = (function () {
		...
		if (typeof window.self !== 'undefined' && window.self.Math === Math) {
			return window.self;
		}
