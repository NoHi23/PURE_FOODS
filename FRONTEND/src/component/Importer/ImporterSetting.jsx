...
const ImporterSetting = () => {
  ...
  const handleDisableAccount = async () => {
    ...
    try {
      const response = await axios.put("http://localhost:8080/delete", { userId });
      ...
      if (response.data?.status === 200) {
        ...
        toast.error("Vô hiệu hoá tài khoản thất bại: " + response.data.message);
      }
    } catch (err) {
      toast.error("Lỗi khi vô hiệu hoá tài khoản: " + err.message);
    }
  };
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (response.data?.status === 200) {
        ...
        toast.error("Xoá tài khoản thất bại: " + response.data.message);
      }
    } catch (err) {
