                  ...
                  <div className="notification-slider">
                    <div>
                      <div className="timer-notification">
                        <h6>
                          <strong className="me-1">Welcome to Fastkart!</strong>Wrap new offers/gift every single day on
                          Weekends.<strong className="ms-1">New Coupon Code: Fast024</strong>
                        </h6>
                      </div>
                    </div>
                  ...
                  <div className="tab-pane fade" id="pills-security" role="tabpanel">
                    <div className="dashboard-privacy">
                      ...
                      <div className="dashboard-bg-box">
                        ...
                        <button className="btn theme-bg-color btn-md fw-bold mt-4 text-white">Delete My Account</button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="footer-logo">
                  ...
                  <div className="footer-logo-contain">
                    <p>
                      We are a friendly bar serving a variety of cocktails, wines and beers. Our bar is a perfect place
                      for a couple.
                    </p>
            ...
            <div className="modal-body">
              <form>
                ...
                <div className="mb-3">
                  ...
                  <input type="email" className="form-control" id="emailAddress" defaultValue="joshuadbass@rhyta.com" />
                </div>
                <div className="mb-3">
