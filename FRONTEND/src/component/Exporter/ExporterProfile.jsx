    ...
    <div className="dashboard-profile">
      ...
      <div className="profile-tab dashboard-bg-box">
        ...
        <ul>
          ...
          <li>
            <h5>Họ và tên :</h5>
            <h5 style={{ fontSize: "18px", fontWeight: "bold" }}>{user?.fullName || "Không rõ"}</h5>
          </li>
          <li>
            <h5>Địa chỉ Email :</h5>
            <h5 style={{ fontSize: "18px", fontWeight: "bold" }}>{user?.email || "Không rõ"}</h5>
          </li>
          <li>
            <h5>Số điện thoại :</h5>
            <h5 style={{ fontSize: "18px", fontWeight: "bold" }}>{user?.phone || "Không rõ"}</h5>
          </li>
          <li>
            <h5>Địa chỉ :</h5>
            <h5 style={{ fontSize: "18px", fontWeight: "bold" }}>{user?.address || "Không rõ"}</h5>
          </li>
          <li>
            <h5>Chức vụ :</h5>
          ...
          <li>
            <h5>Mật khẩu :</h5>
            <h5 style={{ fontSize: "18px", fontWeight: "bold", color: "orange" }}>
              Có thể đổi mật khẩu trong nút chỉnh sửa thông tin
            </h5>
          </li>
        </ul>
      </div>
