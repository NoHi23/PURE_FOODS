...
public class TemplateUtil {
    ...
    public static String getResetPasswordTemplate(String token, String fullName) {
        ...
        return """
                                       ...
                                       <td>
                                           ...
                                           <table class="button-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                                               ...
                                               <thead>
                                                   <tr style="display: block;">
                                                       <td style="display: block;">
                                                           <button class="password-button">Set a new password</button>
                                                       </td>
                                                   </tr>
                                               </thead>
                                           </table>
                                                           ...
                                                           <tr>
                                                               <td>
                                                                   <h4 style="font-size: 19px; font-weight: 700; margin: 0;">Shop For <span
                                                                           class="theme-color">Pure Food</span></h4>
                                                               </td>
                                                           </tr>
                                                       </table>
                                                       <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon text-center"
                ...
                """.formatted(fullName != null ? fullName : "User", resetLink);
    }
}
